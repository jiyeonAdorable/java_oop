...
public class FormatterExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(formatter.format("%,+-20d", number)); //+는 부호고, -는 좌측 정렬..
		...
		//순서 지정 1$ 첫번째부터..꼭해줘야함 출력이 두개 이상일때는
		...
		System.out.println(String.format("%1$tY-%1$tm-%1$td %1$tH:%1$tM:%1$tS %1$tA",
		...
		hireDate.set(Calendar.MONTH, 2); //3-1
		hireDate.set(Calendar.DAY_OF_MONTH, 13);
		
		System.out.printf("%1$tF %1$tT",hireDate);
